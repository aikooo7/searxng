...
def search():
    ...
    if sxng_request.preferences.get_value("spellcheck") == "1" and search.search_query.lang[0:2] in SpellChecker.languages():
...
def preferences():
    ...
    return render(
        ...
        spellcheck = sxng_request.preferences.get_value("spellcheck"),
        stats = stats,
